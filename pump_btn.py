...
class PumpButtons(object):
  def __init__(self, sm_list):
    ...
    self.b1 = PButton(pin=B1, bounce_time=BOUNCE_TIME, hold_time=HOLD_TIME, sm=init_sm)
    self.b2 = PButton(pin=B2, bounce_time=BOUNCE_TIME, hold_time=HOLD_TIME, sm=init_sm)
    self.b3 = PButton(pin=B3, bounce_time=BOUNCE_TIME, hold_time=HOLD_TIME, sm=init_sm)
