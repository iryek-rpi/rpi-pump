...
class SetSet420MAStateMachine():
  states = [
      { 'name':'ENTER_SET_LEVEL', 'on_enter':['enter_set_level'] }
    , { 'name':'LEVEL_HIGH_4', 'on_enter':['high_4'] }
    , { 'name':'LEVEL_HIGH_3', 'on_enter':['high_3'] }
    , { 'name':'LEVEL_HIGH_2', 'on_enter':['high_2'] }
    , { 'name':'LEVEL_HIGH_1', 'on_enter':['high_1'] }
    , { 'name':'LEVEL_LOW_3', 'on_enter':['low_3'] }
    , { 'name':'LEVEL_LOW_2', 'on_enter':['low_2'] }
    , { 'name':'LEVEL_LOW_1', 'on_enter':['low_1'] }
  ...
  transitions = [
      { 'source':'*', 'trigger':'enter', 'dest':'ENTER_SET_LEVEL'}
    , { 'source':'ENTER_SET_LEVEL', 'trigger':'init', 'dest':'LEVEL_HIGH_4'}
    , { 'source':'LEVEL_HIGH_4', 'trigger':'btn1_s', 'dest':'LEVEL_HIGH_3'}
    , { 'source':'LEVEL_HIGH_3', 'trigger':'btn1_s', 'dest':'LEVEL_HIGH_2'}
    , { 'source':'LEVEL_HIGH_2', 'trigger':'btn1_s', 'dest':'LEVEL_HIGH_1'}
    , { 'source':'LEVEL_HIGH_1', 'trigger':'btn1_s', 'dest':'LEVEL_LOW_3'}
    , { 'source':'LEVEL_LOW_3', 'trigger':'btn1_s', 'dest':'LEVEL_LOW_2'}
    , { 'source':'LEVEL_LOW_2', 'trigger':'btn1_s', 'dest':'LEVEL_LOW_1'}
    , { 'source':'LEVEL_LOW_1', 'trigger':'btn1_s', 'dest':'LEVEL_HIGH_4'}

    , { 'source':'LEVEL_HIGH_4', 'trigger':'btn2_s', 'dest':'LEVEL_HIGH_4', 'before':'h_4_inc'}
    , { 'source':'LEVEL_HIGH_4', 'trigger':'btn3_s', 'dest':'LEVEL_HIGH_4', 'before':'h_4_dec'}
    , { 'source':'LEVEL_HIGH_3', 'trigger':'btn2_s', 'dest':'LEVEL_HIGH_3', 'before':'h_3_inc'}
    , { 'source':'LEVEL_HIGH_3', 'trigger':'btn3_s', 'dest':'LEVEL_HIGH_3', 'before':'h_3_dec'}
    , { 'source':'LEVEL_HIGH_2', 'trigger':'btn2_s', 'dest':'LEVEL_HIGH_2', 'before':'h_2_inc'}
    , { 'source':'LEVEL_HIGH_2', 'trigger':'btn3_s', 'dest':'LEVEL_HIGH_2', 'before':'h_2_dec'}
    , { 'source':'LEVEL_HIGH_1', 'trigger':'btn2_s', 'dest':'LEVEL_HIGH_1', 'before':'h_1_inc'}
    , { 'source':'LEVEL_HIGH_1', 'trigger':'btn3_s', 'dest':'LEVEL_HIGH_1', 'before':'h_1_dec'}

    , { 'source':'LEVEL_LOW_3', 'trigger':'btn2_s', 'dest':'LEVEL_LOW_3', 'before':'L_3_inc'}
    , { 'source':'LEVEL_LOW_3', 'trigger':'btn3_s', 'dest':'LEVEL_LOW_3', 'before':'L_3_dec'}
    , { 'source':'LEVEL_LOW_2', 'trigger':'btn2_s', 'dest':'LEVEL_LOW_2', 'before':'L_2_inc'}
    , { 'source':'LEVEL_LOW_2', 'trigger':'btn3_s', 'dest':'LEVEL_LOW_2', 'before':'L_2_dec'}
    , { 'source':'LEVEL_LOW_1', 'trigger':'btn2_s', 'dest':'LEVEL_LOW_1', 'before':'L_1_inc'}
    , { 'source':'LEVEL_LOW_1', 'trigger':'btn3_s', 'dest':'LEVEL_LOW_1', 'before':'L_1_dec'}
  ...
  def enter_set_level(self):
    ...
    self.high_old = [ 
        self.pv.setting_high//1000
      , (self.pv.setting_high//100)%10
      , (self.pv.setting_high//10)%10
      , self.pv.setting_high%10
    ] 
    self.low_old = [ 
        self.pv.setting_low//100
      , (self.pv.setting_low//10)%10
