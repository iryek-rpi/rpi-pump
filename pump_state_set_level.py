...
class SetLevelStateMachine():
  states = [
      { 'name':'ENTER-SET-LEVEL', 'on_enter':['enter_set_level'] }
    , { 'name':'LEVEL-HIGH-010', 'on_enter':['high_2'] }
    , { 'name':'LEVEL-HIGH-01', 'on_enter':['high_1'] }
    , { 'name':'LEVEL-LOW-010', 'on_enter':['low_2'] }
    , { 'name':'LEVEL-LOW-01', 'on_enter':['low_1'] }
  ...
  transitions = [
      { 'source':'*', 'trigger':'enter', 'dest':'ENTER-SET-LEVEL'}
    , { 'source':'ENTER-SET-LEVEL', 'trigger':'init', 'dest':'LEVEL-HIGH-010'}
    , { 'source':'*', 'trigger':'btn1_l', 'dest':'SETTING-NEXT'}
    #, { 'source':'*', 'trigger':'leave', 'dest':'LEAVE_SET_LEVEL'}
    , { 'source':'LEVEL-HIGH-010', 'trigger':'btn1_s', 'dest':'LEVEL-HIGH-01'}
    , { 'source':'LEVEL-HIGH-01', 'trigger':'btn1_s', 'dest':'LEVEL-LOW-010'}
    , { 'source':'LEVEL-LOW-010', 'trigger':'btn1_s', 'dest':'LEVEL-LOW-01'}
    , { 'source':'LEVEL-LOW-01', 'trigger':'btn1_s', 'dest':'LEVEL-HIGH-010'}

    , { 'source':'LEVEL-HIGH-010', 'trigger':'btn2_s', 'dest':'LEVEL-HIGH-010', 'before':'h10_inc'}
    , { 'source':'LEVEL-HIGH-010', 'trigger':'btn3_s', 'dest':'LEVEL-HIGH-010', 'before':'h10_dec'}
    , { 'source':'LEVEL-HIGH-01', 'trigger':'btn2_s', 'dest':'LEVEL-HIGH-01', 'before':'h01_inc'}
    , { 'source':'LEVEL-HIGH-01', 'trigger':'btn3_s', 'dest':'LEVEL-HIGH-01', 'before':'h01_dec'}

    , { 'source':'LEVEL-LOW-010', 'trigger':'btn2_s', 'dest':'LEVEL-LOW-010', 'before':'L10_inc'}
    , { 'source':'LEVEL-LOW-010', 'trigger':'btn3_s', 'dest':'LEVEL-LOW-010', 'before':'L10_dec'}
    , { 'source':'LEVEL-LOW-01', 'trigger':'btn2_s', 'dest':'LEVEL-LOW-01', 'before':'L01_inc'}
    , { 'source':'LEVEL-LOW-01', 'trigger':'btn3_s', 'dest':'LEVEL-LOW-01', 'before':'L01_dec'}
