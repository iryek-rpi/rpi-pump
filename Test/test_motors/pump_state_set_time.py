...
class SetTimeStateMachine():
  states = [{
      'name': 'ENTER_TIME_SETTING',
      'on_enter': ['enter_time_setting']
  }, {
      'name': 'YEAR10',
      'on_enter': ['year10']
  }, {
      ...
      'name': 'SAVE_OR_NOT',
      'on_enter': ['save_or_not']
  }, {
      'name': 'SAVE_TIME',
      'on_enter': ['save_time']
  }, {
      'name': 'DONT_SAVE_TIME',
      'on_enter': ['dont_save_time']
  }, {
      'name': 'LEAVE_TIME_SETTING',
      'on_enter': ['leave_time_setting']
  }]
  ...
  transitions = [
      {
          'source': '*',
          'trigger': 'enter',
          'dest': 'ENTER_TIME_SETTING'
      },
      {
          'source': 'ENTER_TIME_SETTING',
          'trigger': 'init',
          'dest': 'YEAR10'
      },
      {
